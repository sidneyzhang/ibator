 ...
 * of the Ibator housekeeping methods needed to implement a code generator, with
...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		ATTR_DAO_IMPLEMENTATION_TYPE, ATTR_DAO_INTERFACE_TYPE, ATTR_PRIMARY_KEY_TYPE, ATTR_BASE_RECORD_TYPE, ATTR_RECORD_WITH_BLOBS_TYPE, ATTR_EXAMPLE_TYPE, ATTR_IBATIS2_SQL_MAP_PACKAGE, ATTR_IBATIS2_SQL_MAP_FILE_NAME, ATTR_IBATIS2_SQL_MAP_NAMESPACE, ATTR_IBATIS3_XML_MAPPER_PACKAGE, ATTR_IBATIS3_XML_MAPPER_FILE_NAME, ATTR_IBATIS3_JAVA_MAPPER_TYPE, // also
																																																																																								// used
																																																																																								// as
																																																																																								// XML
																																																																																								// Mapper
	...
	public void setIbatis3UpdateByExampleWhereClauseId(String s) {
		internalAttributes
				.put(InternalAttribute.ATTR_IBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID,
						s);
	}
	...
	public String getIbatis3UpdateByExampleWhereClauseId() {
		return internalAttributes
				.get(InternalAttribute.ATTR_IBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID);
	}
	...
	protected String calculateDAOImplementationPackage() {
		DAOGeneratorConfiguration config = ibatorContext
	...
	protected String calculateJavaModelPackage() {
		JavaModelGeneratorConfiguration config = ibatorContext
	...
	public String getIbatis3XmlMapperPackage() {
		return internalAttributes
				.get(InternalAttribute.ATTR_IBATIS3_XML_MAPPER_PACKAGE);
	}

	public void setIbatis3XmlMapperPackage(String ibatis3XmlMapperPackage) {
		internalAttributes.put(
				InternalAttribute.ATTR_IBATIS3_XML_MAPPER_PACKAGE,
				ibatis3XmlMapperPackage);
	}

	public String getIbatis3XmlMapperFileName() {
		return internalAttributes
				.get(InternalAttribute.ATTR_IBATIS3_XML_MAPPER_FILE_NAME);
	}

	public void setIbatis3XmlMapperFileName(String ibatis3XmlMapperFileName) {
		internalAttributes.put(
				InternalAttribute.ATTR_IBATIS3_XML_MAPPER_FILE_NAME,
				ibatis3XmlMapperFileName);
	}

	public String getIbatis3JavaMapperType() {
		return internalAttributes
				.get(InternalAttribute.ATTR_IBATIS3_JAVA_MAPPER_TYPE);
	}

	public void setIbatis3JavaMapperType(String ibatis3JavaMapperType) {
		internalAttributes.put(InternalAttribute.ATTR_IBATIS3_JAVA_MAPPER_TYPE,
				ibatis3JavaMapperType);
	}
