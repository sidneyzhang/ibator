...
public class IbatorContext extends PropertyHolder {
	...
	private final List<IbatorPluginConfiguration> pluginConfigurations;
		...
		try {
			...
			for (TableConfiguration tc : tableConfigurations) {
				String tableName = StringUtility
						.composeFullyQualifiedTableName(tc.getCatalog(),
	...
	public void generateFiles(ProgressCallback callback,
		...
		for (IbatorPluginConfiguration ibatorPluginConfiguration : pluginConfigurations) {
			IbatorPlugin plugin = IbatorObjectFactory.createIbatorPlugin(this,
